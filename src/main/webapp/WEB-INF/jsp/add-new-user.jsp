...
<%--                </th>--%>
<%--                    &lt;%&ndash;            data-toggle="modal" data-target="#userModal1"&ndash;%&gt;--%>
<%--                <th>--%>
...
<%--                </c:forEach>--%>
        ...
        <span class="tete">
                ...
                <button type="button" id="add_button" data-toggle="modal" data-target="#userModal"
                        class="btn btn-success btn-lg pind">Add new
                </button>
            </span>
    </div>
...
<%--                </c:forEach>--%>
        ...
        <span class="tete">
                <a class="btn btn-success btn-lg pind" href="/logout"> Logout</a>
                <button type="button" id="add_button1" data-toggle="modal" data-target="#userModal"
                        class="btn btn-success btn-lg pind">Add new
                </button>
            </span>
    </div>
...
<%--                </c:forEach>--%>
        ...
        <span class="tete">
                <a class="btn btn-success btn-lg pind" href="/logout"> Logout</a>
                <button type="button" id="add_button2" data-toggle="modal" data-target="#userModal"
                        class="btn btn-success btn-lg pind">Add new
                </button>
            </span>
    </div>
...
<%--                </c:forEach>--%>
        ...
        <span class="tete">
                <a class="btn btn-success btn-lg pind" href="/logout"> Logout</a>
                <button type="button" id="add_button3" data-toggle="modal" data-target="#userModal"
                        class="btn btn-success btn-lg pind">Add new
                </button>
            </span>
    </div>
...
<%--                </c:forEach>--%>
        ...
        <span class="tete">
                <a class="btn btn-success btn-lg pind" href="/logout"> Logout</a>
                <button type="button" id="add_button4" data-toggle="modal" data-target="#userModal"
                        class="btn btn-success btn-lg pind">Add new
                </button>
            </span>
    </div>
...
<%--                <th scope="col" width="5%">Edit</th>--%>
            ...
            <tbody class="teacherSalary-table">
...
<%--                </c:forEach>--%>
        ...
        <span class="tete">
                <a class="btn btn-success btn-lg pind" href="/logout"> Logout</a>
                <button type="button" id="add_button5" data-toggle="modal" data-target="#userModal"
                        class="btn btn-success btn-lg pind">Add new
                </button>
            </span>
    </div>
        ...
        <form method="post" id="people_form" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" placeholder="write the number plz" name="numbers" id="numbers"
                           class="form-control"/>
                    <br/>
                    <label>Enter E-mail</label>
                    <input type="text" placeholder="write the Emial plz" name="emails" id="emails"
                           class="form-control"/>
                    <br/>
                    <label>Enter Your Date of brith </label>
                    <input type="date" placeholder="write the brithday date < yy-mm-dd > plz" name="data_of_brith"
                           id="data_of_brith" class="form-control"/>
                    <br/>
                    <label>Enter Your password </label>
                    <input type="text" placeholder="write the password" name="password1" id="password1"
                           class="form-control"/>
                    <br/>
                    <label>re write Your password </label>
                    <input type="text" placeholder=" re write the password" name="password2" id="password2"
                           class="form-control"/>
                    <br/>
        ...
        <form method="post" id="new_people_form" enctype="multipart/form-data">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <br/>
                    <label>Enter Phone Number </label>
                    <input type="text" placeholder="write the number plz" name="numbers" id="numbers1"
                           class="form-control"/>
                    <br/>
                    <label>Enter E-mail</label>
                    <input type="text" placeholder="write the Emial plz" name="emails" id="emails1"
                           class="form-control"/>
                    <br/>
                    <label>Enter Your Date of brith </label>
                    <input type="date" placeholder="write the brithday date < yy-mm-dd > plz" name="data_of_brith"
                           id="data_of_brith1" class="form-control"/>
                    <br/>
                    <label>Enter Your password </label>
                    <input type="text" placeholder="write the password" name="password1" id="password11"
                           class="form-control"/>
                    <br/>
                    <label>re write Your password </label>
                    <input type="text" placeholder=" re write the password" name="password2" id="password22"
                           class="form-control"/>
                    <br/>
                    <label>Gender is : </label>
                    <span>
